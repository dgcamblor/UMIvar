...
<img src="https://github.com/dgcamblor/UMIvar/assets/74027422/5252112c-da2e-4335-8d46-0be9779fb440" width=50% height=50%>
...
- `-v` or `--variants`: the CSV or VCF file with the variants to be introduced, following the aforementioned specifications. Alternatively, the number of random variants to be introduced can be specified here: inputting a number will activate the random variant mode (requires `-f`). This
...
![UMIvar infographic](https://github.com/dgcamblor/UMIvar/assets/74027422/e37b4fc3-daad-4e7b-afef-fcf6a798b9ea)
