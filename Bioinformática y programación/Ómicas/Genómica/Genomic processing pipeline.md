...
2. **Adapter (and primer) trimming.** Trimming can be performed using a known adapter, or an adapter list ([[Adapter trimming]]. Alternatively, the primers can be clipped after mapping (see [[Primer removal alternatives]])
	- [[cutadapt]] 
